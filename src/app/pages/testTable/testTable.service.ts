...
constructor(private http: Http) { }
  ...
  getData(): Observable<Contact[]> {
    ...
    this.token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJzb21lb25lQHNvbWVvbmUuY29tIiwianRpIjoiZDAyMjdkNWEtZWQ4OC00NWY1LWIwODQtYjZlNjM2OGYzNzczIiwiaWF0IjoiMjgvMTEvMjAxNiAxOjIxOjA0IFBNIiwibmJmIjoxNDgwMzM5MjY0LCJleHAiOjE0ODAzMzk1NjQsImlzcyI6IkV4YW1wbGVJc3N1ZXIiLCJhdWQiOiJFeGFtcGxlQXVkaWVuY2UifQ.X5zlGkb1z2kUmPHusUM-_vmz3ikwgTYk3CHMd5X3oko";
    headers.append('Authorization', 'Bearer ' + this.token);
        return this.http.get('http://localhost:60033/api/Contact', {"headers": headers})
            .map((responseData) => {
